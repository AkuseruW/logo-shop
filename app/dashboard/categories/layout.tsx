                    ...
                    <nav className="flex flex-wrap justify-center lg:justify-start">
                        <ul className="space-x-8 p-4 flex flex-wrap">
                            <li className="flex items-center">
                                <Link href="/dashboard/categories" className="text-gray-700 hover:text-blue-500 font-medium text-lg sm:text-sm">
                            ...
                            <li className="flex items-center">
                                <Link href="/dashboard/categories/new" className="text-gray-700 hover:text-blue-500 font-medium text-lg sm:text-sm">
