...
const CookieConsent = () => {
    ...
    const handleAcceptAllCookies = () => {
        ...
        Cookies.set('cookieConsent', 'true', { expires: expirationDate as Date });
    ...
    return (
        <section
            className={`fixed max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 left-12 bottom-16 dark:bg-gray-800 md:flex md:items-center dark:border-gray-700 rounded-2xl ${showConsent ? 'block' : 'hidden'
                }`}
        >
            <div className="flex items-center gap-x-4">
                <span className="inline-flex p-2 text-blue-500 rounded-lg shrink-0 dark:bg-gray-700 bg-blue-100/80">
            ...
            <div className="flex items-center mt-6 gap-x-4 shrink-0 lg:mt-0">
              ...
              Cookie Settings
                ...
                <button
                    className="text-xs w-1/2 md:w-auto font-medium bg-gray-700 rounded-lg hover:bg-gray-600 text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none"
